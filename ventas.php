		...
		<table class="table table-bordered table-striped">
			...
			<tbody>
				...
				<tr>
					...
					<td><a class="btn btn-info" href="<?php echo "./services/imprimirTicket.php?id=" . $venta->id?>"><i class="fa fa-print"></i></a></td>
					<td><a class="btn btn-danger" href="<?php echo "./services/eliminarVenta.php?id=" . $venta->id?>"><i class="fa fa-trash"></i></a></td>
				</tr>
				<?php } ?>
			</tbody>
		</table>
